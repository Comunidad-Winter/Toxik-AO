...
Me.Picture = General_Load_Picture_From_Resource("boveda.bmp")
m_Number = 1
m_Interval = 30
End Sub
...
If Index = 0 Then
    Image1(Index).Picture = General_Load_Picture_From_Resource("retirar-down.bmp")
    Image1(Index).Tag = "1"
ElseIf Index = 1 Then
    Image1(Index).Picture = General_Load_Picture_From_Resource("depositar-down.bmp")
    Image1(Index).Tag = "1"
End If
...
If Index = 0 Then
    If Image1(Index).Tag = "0" Then
        Image1(Index).Picture = General_Load_Picture_From_Resource("retirar-over.bmp")
        Image1(Index).Tag = "1"
    End If
ElseIf Index = 1 Then
    If Image1(Index).Tag = "0" Then
        Image1(Index).Picture = General_Load_Picture_From_Resource("depositar-over.bmp")
        Image1(Index).Tag = "1"
    End If
End If
...
Select Case Index
    Case 0
        ...
        If UserBancoInventory(List1(0).ListIndex + 1).GrhIndex <> 0 Then
            Call Engine.Grh_Render_To_Hdc(UserBancoInventory(List1(0).ListIndex + 1).GrhIndex, Picture1.hDC, 0, 0)
        Else
